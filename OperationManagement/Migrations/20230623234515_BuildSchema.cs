        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Suppler = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EnterpriseId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Components_Enterprises_EnterpriseId",
                        column: x => x.EnterpriseId,
                        principalTable: "Enterprises",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    GPSURL = table.Column<string>(name: "GPS_URL", type: "nvarchar(max)", nullable: true),
                    EnterpriseId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DeliveryLocations_Enterprises_EnterpriseId",
                        column: x => x.EnterpriseId,
                        principalTable: "Enterprises",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Measurements_Enterprises_EnterpriseId",
                        column: x => x.EnterpriseId,
                        principalTable: "Enterprises",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Processes_Enterprises_EnterpriseId",
                        column: x => x.EnterpriseId,
                        principalTable: "Enterprises",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Specifications_Enterprises_EnterpriseId",
                        column: x => x.EnterpriseId,
                        principalTable: "Enterprises",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ComponentPhotos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ComponentPhotos_Components_ComponentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EnterpriseOrderNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    IsHandOver = table.Column<bool>(type: "bit", nullable: true),
                    CustomerId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProcessStatuses_Processes_ProcessId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpecificationStatuses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SpecificationStatuses_Specifications_SpecificationId",
                        column: x => x.SpecificationId,
                        principalTable: "Specifications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EmterpriseCode = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductProcesses_ProcessStatuses_StatusId",
                        column: x => x.StatusId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProductSpecifications_SpecificationOptions_OptionId",
                        column: x => x.OptionId,
                        principalTable: "SpecificationOptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProductSpecifications_SpecificationStatuses_StatusId",
                        column: x => x.StatusId,
                        principalTable: "SpecificationStatuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ComponentPhotos_ComponentId",
                table: "ComponentPhotos",
                column: "ComponentId");

            migrationBuilder.CreateIndex(
                name: "IX_Components_EnterpriseId",
                table: "Components",
                column: "EnterpriseId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliveryLocations_EnterpriseId",
                table: "DeliveryLocations",
                column: "EnterpriseId");

            migrationBuilder.CreateIndex(
                name: "IX_Measurements_EnterpriseId",
                table: "Measurements",
                column: "EnterpriseId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Processes_EnterpriseId",
                table: "Processes",
                column: "EnterpriseId");

            migrationBuilder.CreateIndex(
                name: "IX_ProcessStatuses_ProcessId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductMeasurements_MeasurementId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductProcesses_StatusId",
                table: "ProductProcesses",
                column: "StatusId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductSpecifications_OptionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductSpecifications_StatusId",
                table: "ProductSpecifications",
                column: "StatusId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Specifications_EnterpriseId",
                table: "Specifications",
                column: "EnterpriseId");

            migrationBuilder.CreateIndex(
                name: "IX_SpecificationStatuses_SpecificationId",
                table: "SpecificationStatuses",
                column: "SpecificationId");
